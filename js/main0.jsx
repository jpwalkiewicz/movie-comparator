        ...
        render() {
            ...
            return <div>
                ...
                <div>
                    ...
                    Title: {this.state.errorLoading1}, {this.state.title1}, {this.state.year1}, {this.state.runtime1}
                    min, {this.state.actorsList1}, {this.state.plot1}

                </div>
                <br/>
                <h1>wspólni aktorzy to: {this.state.actorsListInCommon}
                <br/>
                jezyk: {this.state.languageListInComon}</h1>
                <input type="text" value={this.state.secondTitleinput} onChange={this._handleSecondTitleChange} className="inputSearch"/>

                <div>
                    <img src={this.state.poster2} alt={this.state.title2} title={this.state.title2}/> {this.state.errorLoading2}, Title: {this.state.title2}, {this.state.year2}, {this.state.runtime2}
                    min, {this.state.actorsList2}, {this.state.plot2}
